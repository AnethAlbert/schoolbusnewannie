...
class GardianApiService {
 ...
 // final String url = "http://192.168.100.26:8080";
  //final String url = "http://192.168.0.168:8080";
...
//**************************************GETBYID*************************
  Future<String?> getProfilePictureById(int id) async {
    final String apiUrlid = '/api/v1/gurdianProfile/$id/profilepicture'; // Update the API URL with the correct ID
  ...
  Future<List<Gurdian>> getAllGurdians() async {
    try {
      final response = await http.get(
        Uri.parse(apiUrl),
        headers: {'Content-Type': 'application/json'},
