              ...
              child: Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String? profilePictureBase64 = studentsSearch[index]['profilepicture'];

                    // Decode the base64-encoded profilepicture to Uint8List
                    Uint8List? profilePictureBytes = profilePictureBase64 != null
                   ...
                   // print("Profile Picture Base64 for Student ${studentsSearch[index]['id']}: $profilePictureBase64");
                    print("Profile Picture Bytes for Student ${studentsSearch[index]['mysqlId']}: $profilePictureBytes");

                    return Material(
                      child: GestureDetector(
                        onTap: () {},
                        child: StudentCardAddRelation(
                          ...
                          profilePicture: profilePictureBytes, // Pass the profile picture bytes
                        ),
                      ),
                    );
                  },
